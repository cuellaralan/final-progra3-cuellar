...
{ // va a manejar todas las rutas de usuario
        ...
        isset($token)  && isset($datos["nacionalidad"]) && !empty($files) )
        {
            if($datos["nombre"] != "" && $datos["precio"]  && $datos["nacionalidad"] != "" && $token != "" )
            {
                ...
                if($verifica)
                {
                    ...
                    {
                        // var_dump($datos);
                        $rta ['response'] = "cripto ya en base";
                    }
                    else
                    {
                        // var_dump($datos);
    ...
    public function traerCripto(Request $request, Response $response, $args)
    {
        //respuesta
        $rta = array();
        $rta ['status'] = "Nok";
        ...
        if(isset($token)  && isset($id)  )
        {
            if($id != ""  && $token != "" )
            {
                ...
                if($verifica)
                {
                    ...
                    {
                        $rta ['response'] = "No existe cripto por id";
                    }
                }
            }
            else
            {
                $rta ['response'] = "datos erroneos";
    ...
    public function listCriptos(Request $request, Response $response, $args)
    {
        //respuesta
        $rta = array();
        $rta ['status'] = "ok";
